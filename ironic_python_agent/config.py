...
cli_opts = [
    ...
    cfg.StrOpt('arobot_callback_url',
               default=APARAMS.get('ipa-arobot-callback-url'),
               help='Endpoint of arobot. If set, ipa will call API'
                    'to get configurations, like ipmi address.'
                    'on start up. And then configure it.'
                    'Can be supplied as "ipa-arobot-callback-url" '
                    'kernel parameter.'),
...
front_ops = [
    ...
    cfg.IntOpt('disk_num',
               default=3,
               help='Disk number.'),
    cfg.IntOpt('disk_size',
               default=300,
               help='Disk size in GB.'),
    cfg.IntOpt('raid_level',
               default=5,
               help='RAID level.'),
]
...
CONF.register_opts(front_ops, group='front_end_computer')
CONF.register_opts(db_a_ops, group='DB_computer_A')
CONF.register_opts(db_b_ops, group='DB_computer_B')
